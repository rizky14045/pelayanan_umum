...
<script>
  ...
  // Existing record already has a confirmed point saved, keep it valid until tujuan is touched
...
//   var map = $("#input-latlng").data('map');
//   map.setRoutes(JSON.parse($("#input-rute").val()));
// });
</script>
@endscript